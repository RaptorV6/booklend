...
### Kalkulace nákladů na vývoj (komerční odhad)

| Role | Sazba/MD | Čas | MD | Výsledek |
|------|----------|-----|----|----------|
| Vedoucí vývojář (full-stack) | 8 000 Kč | ~40 hod | 5,0 | 40 000 Kč |
| UI/UX designér | 6 500 Kč | ~12 hod | 1,5 | 9 750 Kč |
| Frontend designér, tester | 5 500 Kč | ~10 hod | 1,25 | 6 875 Kč |
| Projektový manažer | 7 000 Kč | ~8 hod | 1,0 | 7 000 Kč |
| Analytik, dokumentace | 5 500 Kč | ~8 hod | 1,0 | 5 500 Kč |
| **Celkem** | | **~78 hod** | **9,75** | **69 125 Kč** |

> 1 MD = 8 hodin. Sazby vychází z obvyklých cen na českém IT trhu (zdroj: Přehled obvyklých cen ICT prací, MV ČR).
